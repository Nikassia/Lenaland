...
# Реализация функционала паузы в игре
...
class Pause:
    def __init__(self, screen, entity, dashboard):
        ...
        self.pause_srfc = GaussianBlur().filter(self.screen, 0, 0, 640, 480) # Размытость при паузе
...
# Обновление состояния паузы на экране
    def update(self):
        ...
        self.checkInput() # Проверка ввода от пользователя
...
# Создаем размытую поверхность на фоне паузы
