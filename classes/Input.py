...
# Данный код представляет класс Input, который обрабатывает ввод от пользователя в игре.
...
# проверка события ввода (клавиатура, мышь, выход из игры)
...
# обработка ввода с клавиатуры (направление, прыжок)
...
# Проверка события выхода из игры и перезапуска
...
# Проверка состояния кнопки мыши в событиях
